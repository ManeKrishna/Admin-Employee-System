...
const CompletedTask = ({employeedata}) => {
  return (
    ...
    <div className='h-fill'><h1 className='px-5 text-2xl font-bold pb-1'>{employeedata.taskTitle}</h1></div>
    ...
    <div className='flex  items-center mb-5 px-4'>
        <button className='bg-green-700 w-full text-white rounded-xl py-1 px-2 text-lg'>Completed</button>
