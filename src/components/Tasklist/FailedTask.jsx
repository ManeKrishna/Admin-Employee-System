...
const FailedTask = ({ employeedata }) => {
  return (
    <div className='flex-shrink-0 h-full w-[280px] sm:w-[300px] bg-red-400 rounded-xl flex flex-col'>
      ...
      <div className='flex items-center mb-4 sm:mb-5 px-4'>
        <button className='bg-red-700 w-full text-white rounded-xl py-1 px-2 text-base sm:text-lg cursor-not-allowed'>
          Failed
        </button>
      </div>
    </div>
