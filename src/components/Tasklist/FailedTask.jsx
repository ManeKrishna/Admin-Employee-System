...
const FailedTask = ({ employeedata }) => {
  return (
    <div className='flex-shrink-0 h-full w-[300px] bg-red-400 rounded-xl flex flex-col'>
      ...
      <div className='flex items-center mb-5 px-4'>
        <button className='bg-red-700 w-full text-white rounded-xl py-1 px-2 text-lg cursor-not-allowed'>
          Failed
        </button>
      </div>
    </div>
