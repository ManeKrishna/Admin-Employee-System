  ...
  return (  
    <div className='flex-shrink-0 h-full  w-[300px] bg-orange-300 rounded-xl flex flex-col'>
            ...
            <div className='flex justify-between items-center   mb-5 px-4'>
                <button className='bg-green-700 text-white rounded-xl py-1 px-2 text-lg'>Completed</button>
                <button className='bg-red-700 text-white rounded-xl py-1 px-2 text-lg'>Failed</button>
            </div>        
        </div>
  )
}
